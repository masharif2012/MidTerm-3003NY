...
public class EmployeeInfo extends CompanyInfo implements Employee {
    ...
    public static double calculateEmployeeBonus(int salary, int performance) {
        ...
        if (performance == 5) {
            ...
            yearlyBonus = 0;
            System.out.println("performance is not as expected.");
        } else {
            yearlyBonus = 0;
    ...
    public static double calculateEmployeePension(int salary ){
        ...
        System.out.println("Please enter start date in format (example: Jan,2019): ");
        String joiningDate = sc.nextLine();
        System.out.println("Please enter today's date in format (example: January,2018): ");
        ...
        System.out.println("Total Pensions: $" + total);
    ...
    public void benefitLayout() {
        System.out.println("You may get 1 month(30 Days) paid leave");
    }

    @Override
    public void companyProfile() {
        System.out.println("                     Welcome to Sharif's Consultancy\n"+"                  Sharif's Consultancy is here to serve you better!");
    }
}
