...
public class FortuneEmployee {
	...
	public static void main(String[] args) {
		...
		EmployeeInfo employee1 = new EmployeeInfo(001,"James Bond","Marketing");
		EmployeeInfo employee2 = new EmployeeInfo(002,"Sherlock Holmse","Entertainment");
		EmployeeInfo employee3 = new EmployeeInfo(003,"Tom Cruise","Technology");
		EmployeeInfo employee4 = new EmployeeInfo(004,"Tedd baker","Business");
		EmployeeInfo employee5 = new EmployeeInfo(005,"Dwayne Johnson","Billing");
